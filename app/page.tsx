  ...
  return (
    <main className="space-y-8">
      ...
      <section className="relative overflow-hidden rounded-3xl hero-gradient p-8 md:p-12">
        <div className="relative z-10">
          <div className="fade-in-up">
            ...
            <p className="text-lg md:text-xl text-stone-700 max-w-3xl leading-relaxed mb-8">
              Explore the life of Prophet Muhammad (ﷺ) through interactive timelines, 
              immersive stories, and timeless lessons that shape our understanding of faith and humanity.
            </p>
        ...
        <div className="absolute bottom-10 left-10 w-16 h-16 bg-emerald-200/30 rounded-full floating-animation" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-1/2 right-1/4 w-12 h-12 bg-purple-200/30 rounded-full floating-animation" style={{animationDelay: '4s'}}></div>
      </section>
