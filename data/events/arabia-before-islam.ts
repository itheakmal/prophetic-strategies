...
export const arabiaBeforeIslam: EventData = {
	...
	quotes: [
		{
			...
			details: "In Ṣaḥīḥ al-Bukhārī (ḥadīth 5127) ʿĀ'ishah (RA) describes the different forms of marriages that existed before Islam. 1. Formal Marriage (Resembled Today's Nikāḥ). 2. Nikāḥ al-Istibḍāʾ (Strategic Conception for Tribal Protection). 3. Group Marriages (Rotational Paternity). 4. Open Prostitution (Flag Marriage)",
		}
	],
	deeper: [
	...
	media: [],
	lessons: ["Pre-Islamic Arabian Peninsula had Fragmented Tribal Society no Central Government, it was a collection of tribes, clans, and families.", "Arabia's Neighbors were two great empires, The Roman and Persian Empires.", "Banu Ghassan (Roman Allies) neighbors of the Roman Empire, embraced Christianity.", "Banu Lakhm (Persian Allies) neighbors of the Persian Empire, remained polytheists.", "Societies without unity or central governance risk becoming proxies for stronger powers, their resources and people used to serve foreign interests.", "Jāhiliyyah economy was seasonal trade, ribā, raiding and slavery"],
	parallels: ["Overton Window (modern political science concept): It describes the range of ideas a society sees as acceptable or mainstream.", "Politicians (or leaders) operate within this window to gain support.", "Ideas outside the window are dismissed as strange, unacceptable, or too radical."],
	followups: {
		action: {
