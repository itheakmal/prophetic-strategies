...
export const reconstructionOfTheKabah: EventData = {
  ...
  followups: {
    action: {
      prompt:
        "Why did Quraysh stop rebuilding the Kaʿbah before completing Ibrāhīm's full foundation?",
      type: 'dropdown',
      choices: [
      ...
      correctIndex: 0,
      explanation:
        'Quraysh stopped because they ran out of ḥalāl wealth, refusing to use ribā, gambling, or unjust earnings.',
    },
    reaction: {
      prompt:
