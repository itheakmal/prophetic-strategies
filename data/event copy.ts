...
export const EVENT = {
  ...
  quote: {
    text:
      "I witnessed a pact in the house of Ibn Jud'ān; if I were called to it in Islam, I would respond.",
  ...
  media: [
    { type: "image", src: "https://placehold.co/800x450?text=Hilf+al-Fudul+1", alt: "Placeholder illustration 1" },
    { type: "image", src: "https://placehold.co/800x450?text=Meccan+Market", alt: "Placeholder illustration 2" },
    { type: "video", src: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4", poster: "https://placehold.co/800x450?text=Video+Poster", alt: "Placeholder video" },
  ],
  lessons: [
...
export type Followup =
  | typeof EVENT.followups.action
  | typeof EVENT.followups.reaction;
