  ...
  return (
    <main className='space-y-16'>
      ...
      <section className='relative overflow-hidden rounded-3xl hero-gradient p-8 md:p-16 text-center'>
        <div className='relative z-10 max-w-4xl mx-auto'>
          <div className='fade-in-up'>
            ...
            <p className='text-xl md:text-2xl text-stone-700 leading-relaxed mb-8'>
              The life of Prophet Muhammad (ﷺ) is not just history—it's a living
              guide that illuminates our path in the modern world.
            </p>
            <Link
              href='/'
        ...
        <div
          className='absolute bottom-20 left-20 w-20 h-20 bg-emerald-200/40 rounded-full floating-animation'
          style={{ animationDelay: '3s' }}
        ></div>
        <div
          className='absolute top-1/2 right-1/3 w-16 h-16 bg-purple-200/40 rounded-full floating-animation'
      ...
      <section className='space-y-12'>
        <div className='text-center fade-in-up'>
          ...
          <p className='text-lg text-stone-600 max-w-3xl mx-auto'>
            ...
            how it transforms our understanding of faith, leadership, and
      ...
      <section className='relative overflow-hidden rounded-3xl bg-gradient-to-br from-stone-900 to-stone-800 p-8 md:p-16 text-center'>
        <div className='relative z-10 max-w-4xl mx-auto'>
          <div className='fade-in-up'>
            ...
            <cite className='text-lg text-stone-300'>— Quran 33:21</cite>
          </div>
        </div>
      ...
      <section className='space-y-12'>
        <div className='text-center fade-in-up'>
          ...
          <p className='text-lg text-stone-600 max-w-3xl mx-auto'>
            The Prophet's (ﷺ) life offers practical solutions to contemporary
            challenges in leadership, social justice, and human development.
          </p>
        </div>
        ...
        <div className='grid gap-8 md:grid-cols-2'>
          ...
          <div className='card p-8 fade-in-up stagger-2'>
            ...
            <p className='text-stone-700 leading-relaxed mb-6'>
              The Prophet (ﷺ) demonstrated exceptional strategic thinking. He
              formed alliances, knew when to confront and when to negotiate. His
              decisions reflected a deep awareness of the geopolitical dynamics
              of his time.
            </p>
            <ul className='space-y-3'>
              <li className='flex items-start gap-3'>
                ...
                <span className='text-stone-700'>
                  The early secret phase of da'wah
                </span>
              </li>
              <li className='flex items-start gap-3'>
                <div className='w-2 h-2 bg-emerald-500 rounded-full mt-2 flex-shrink-0'></div>
                <span className='text-stone-700'>
                  Migration to Abyssinia (Habashah)
                </span>
              </li>
              <li className='flex items-start gap-3'>
                <div className='w-2 h-2 bg-emerald-500 rounded-full mt-2 flex-shrink-0'></div>
      ...
      <section className='text-center fade-in-up'>
        <div className='card p-8 md:p-12 max-w-4xl mx-auto'>
          ...
          <p className='text-lg text-stone-700 leading-relaxed mb-8 max-w-2xl mx-auto'>
            ...
            of the Prophet's (ﷺ) life and transforming their understanding of
            faith.
          </p>
